...
左侧栏默认选中 Franklin，顶栏显示 Franklin AI · Franklin
切换到"西格玛"，发哲学问题，确认以哲学视角回答
点击 + 新建自定义角色，填写名称和提示词，确认出现在列表
刷新页面，自定义角色仍存在；hover 显示 × 可删除
连续对话 6+ 轮，网络面板确认只传最近 10 条消息 + systemPrompt
流式输出中点击停止按钮，确认中断
发含代码的请求，验证代码高亮 + 复制按钮
